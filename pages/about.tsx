...
export default function Example() {
  return (
    <div className="relative">
      <Head>
        <title>About | Quotom</title>
        <meta name="description" content="About the company Quotom. A split payment platform." />
      ...
      <div className="relative overflow-hidden bg-gray-900 py-16">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-prose text-lg">
            <h1>
              ...
              <span className="mt-2 block text-center text-3xl font-bold leading-8 tracking-tight text-gray-200 sm:text-4xl">
                Quotom: A payment platform to split & share payments.
              </span>
            </h1>
          ...
          <div className="prose prose-lg prose-indigo mx-auto mt-6 text-gray-300">
            <p>
              Faucibus commodo massa rhoncus, volutpat. <strong className='text-white'>Dignissim</strong> sed <strong className='text-white'>eget risus enim</strong>.
              ...
              <a href="#" className='text-sky-400'>Mattis mauris semper</a> sed amet vitae sed turpis id.
            </p>
            <ul role="list">
            ...
            <h2 className='text-white'>From beginner to expert in 30 days</h2>
            <p>
            ...
            <h2 className='text-white'>Everything you need to get up and running</h2>
            <p>
